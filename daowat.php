...
<html>
<head>
	<title><?php echo $title_fname; ?> •Manchi Matalu</title>
		...
		include ( "./inc/header.inc.php");
	    	...
	    	echo '<li style="float: right;">
					...
					<div >
						<nav>
						<ul>
						<li><a href="daowat.php?u='.$username.'" style="background-color: #cdcdcd; color: #0b810b">Me</a></li>
					...
					<?php 
						if ($user == $username) {
							echo "
								...
								<div>
								<textarea type='text' id='post' name='daowat' onkeyup='clean('post')' onkeydown='clean('post')' rows='4' cols='58'  class='p_postForm_text' placeholder='Write what u feel...'></textarea>
