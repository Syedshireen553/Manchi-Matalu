...
if ($emaildata) {
	...
	if ($email == "") {
		$error = "<p class='error_echo'>Please type your email!</p>";
	}else if ($email_run >= 1) {
		...
		$error = "<p class='succes_echo'>Email successfully changed.</p>";
						// send email
						$msg = "Successfully your  email has been changed. 
						
						";
						mail($email ," Email Changed",$msg, "From:Daowat <no-reply@daowat.com>");
...
<?php echo $error; ?>
	<ul>
		...
		<li style="float: right;">
			...
			<div class="uiaccountstyle">
				<form action="cbinfo_update.php" method="POST">
				<h2><p>Change Email</p></h2></br>
					 Email: </br><input type="email" name="email" id="email" class="placeholder" size="43" value="<?php echo $db_email; ?>"> </br></br>
